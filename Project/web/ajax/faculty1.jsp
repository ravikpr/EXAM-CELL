...
try
    {
            ...
            query="select Faculty_Id from id_"+id+" where Faculty_Id like '"+department+"%' and "+duty+"<>'*'";
            System.out.println(query);
            rs= stm.executeQuery(query);  

           send="<select name='faculty' id='faclty' onchange='proceed(this.value)' required><option value='SELECT'>SELECT</option>";
            while(rs.next())
                {
...
{
System.out.println("Faculty1.jsp exception occured : "+e.getMessage());
}
//out.println(send);
